...
def test_observability_showcase():
    from sqldim.examples.features.observability.showcase import run_showcase
    run_showcase()
...
async def test_ecommerce_showcase():
    from sqldim.examples.real_world.ecommerce.showcase import run_ecommerce_showcase
    await run_ecommerce_showcase()


@pytest.mark.asyncio
async def test_fintech_showcase():
    from sqldim.examples.real_world.fintech.showcase import run_fintech_showcase
    await run_fintech_showcase()


@pytest.mark.asyncio
async def test_supply_chain_showcase():
    from sqldim.examples.real_world.supply_chain.showcase import run_supply_chain_showcase
...
def test_model_ddl_returns_create_statement():
    ...
    from sqldim.examples.utils import model_ddl
...
def test_order_stage_all_milestones():
    ...
    from sqldim.examples.real_world.ecommerce.showcase import _order_stage
...
def test_coerce_placed_at_invalid_string():
    ...
    from datetime import datetime
    from sqldim.examples.real_world.ecommerce.showcase import _coerce_placed_at
...
def test_scq_detect_shipment_cycles_returns_strings():
    from sqldim.examples.real_world.supply_chain.showcase import _scq_detect_shipment_cycles
...
def test_scq_weighted_shipment_cost():
    from sqldim.examples.real_world.supply_chain.showcase import _scq_weighted_shipment_cost
...
def test_scq_hub_degree_out():
    from sqldim.examples.real_world.supply_chain.showcase import _scq_hub_degree_out
...
def test_scq_regional_density():
    from sqldim.examples.real_world.supply_chain.showcase import _scq_regional_density
