...
def test_growth_accounting_showcase():
    ...
    from sqldim.application.examples.features.growth_accounting.showcase import (
        run_showcase,
    )
...
async def test_nba_analytics_showcase():
    from sqldim.application.examples.real_world.nba_analytics.showcase import (
        run_showcase,
    )
...
async def test_ecommerce_showcase():
    from sqldim.application.examples.real_world.ecommerce.showcase import (
...
async def test_fintech_showcase():
    from sqldim.application.examples.real_world.fintech.showcase import (
...
async def test_supply_chain_showcase():
    from sqldim.application.examples.real_world.supply_chain.showcase import (
...
def test_close_scd2_rows_empty_to_close():
    ...
    from sqldim.application.examples.features.composition.showcase import (
        _close_scd2_rows,
    )
...
def test_order_stage_all_milestones():
    ...
    placed = SimpleNamespace(
        returned_at=None, delivered_at=None, shipped_at=None, paid_at=None
    )
    paid = SimpleNamespace(
        returned_at=None, delivered_at=None, shipped_at=None, paid_at=_dt
    )
    shipped = SimpleNamespace(
        returned_at=None, delivered_at=None, shipped_at=_dt, paid_at=_dt
    )
    dlvrd = SimpleNamespace(
        returned_at=None, delivered_at=_dt, shipped_at=_dt, paid_at=_dt
    )
    retd = SimpleNamespace(
        returned_at=_dt, delivered_at=_dt, shipped_at=_dt, paid_at=_dt
    )
