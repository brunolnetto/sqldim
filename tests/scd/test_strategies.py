...
from sqldim.core.loaders.strategies import (
    BulkInsertStrategy,
    UpsertStrategy,
    MergeStrategy,
)
...
def session():
    ...
    SQLModel.metadata.create_all(engine, tables=[WidgetDim.__table__])
...
def test_bulk_insert(session):
    ...
    records = [
        {"code": "W1", "label": "Widget One"},
        {"code": "W2", "label": "Widget Two"},
    ]
