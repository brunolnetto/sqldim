...
import duckdb
from sqldim.application.examples.real_world.user_activity.models import Device, UserCumulated
...
EXAMPLE_METADATA = {
    "name": "user-activity",
    "title": "User Activity",
    "description": "Bitmask datelist encoding + L7/L28 retention metrics",
    "entry_point": "run_activity_showcase",
}
