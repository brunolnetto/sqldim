...
from sqldim.application.examples.real_world.fintech.models import (
    Account,
    TransferEdge,
    MonthlyBalanceFact,
)
...
EXAMPLE_METADATA = {
    "name": "fintech",
    "title": "Fintech Payment Intelligence",
    "description": "SCD Type 2 risk tiers + payment graph + array-metric balances + drift observability",
    "entry_point": "run_fintech_showcase",
}
