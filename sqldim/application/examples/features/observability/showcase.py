...
Or from Python::
    ...
    from sqldim.application.examples.features.observability import run_showcase
    run_showcase()
"""
...
EXAMPLE_METADATA = {
    ...
    "description": "Schema drift + quality violations as first-class Kimball dimensional facts",
