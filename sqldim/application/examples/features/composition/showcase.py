...
Run:
    PYTHONPATH=. python -m sqldim.application.examples.features.composition.showcase
"""
...
EXAMPLE_METADATA = {
    "name": "composition",
    "title": "Composition & Query",
    "description": "Examples 11-12: star schema pipeline + point-in-time query via DGM",
