"""SaaSUsersSource — saas_growth domain source."""
    ...
    schemas={
        "source": EntitySchema(
            ...
            fields=[
                ...
                FieldSpec(
                    "acq_source", "VARCHAR", kind="choices", choices=_ACQ_SOURCES
                ),
        ...
        changes=[
            ...
            ChangeRule(
                ...
                condition=lambda i, row: (
                    row.get("plan_tier") == "free" and random.random() < 0.3
                ),
            ...
            ChangeRule(
                field="plan_tier",
                condition=lambda i, row: (
                    row.get("plan_tier") == "pro" and random.random() < 0.1
                ),
...
class SaaSUsersSource(SchematicSource):
    ...
    ::
        ...
        import duckdb
        from sqldim.application.examples.real_world.saas_growth.dataset import SaaSUsersSource
