...
@DatasetFactory.register("ecommerce_loyalty_customers")
class LoyaltyCustomersSource(SchematicSource):
...
@DatasetFactory.register("ecommerce_catalog_products")
class CatalogProductsSource(SchematicSource):
...
@DatasetFactory.register("ecommerce_fulfillment_orders")
class FulfillmentOrdersSource(SchematicSource):
