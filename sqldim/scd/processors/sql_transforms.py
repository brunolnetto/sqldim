...
Unlike :class:`~sqldim.processors.transforms.TransformPipeline` (which uses
...
class SQLTransform:
    ...
    Usage::
        ...
        from sqldim.scd.processors.sql_transforms import SQLTransform, SQLTransformPipeline
